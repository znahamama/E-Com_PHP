...
?>
<p><?php echo $fetch_cart['name']; ?> <span>(<?php echo $fetch_cart['price'].'LE'.'x'. $fetch_cart['quantity']; ?>)</span></p> 
<?php
}
}else{
...
?>
<div class="grand-total">Total : <span><?php echo $grand_total;?>LE</span></div>
</section>
...
<input type="number" name="number" required placeholder="enter your number">
 ...
 <div class="inputBox">
<span>Your Email :</span><input type="email" name="email" required placeholder="enter your email">
</div>
<div class="inputBox">
<span>Address Line 01 :</span>
<input type="number" min="0" name="flat" required placeholder="e.
g. flat no."> </div> 
<div class="inputBox">
<span>Address Line 01 :</span><input type="text" name="street" required placeholder="e.g.
street name"></div>
<div class="inputBox"> 
    <span>City :</span>
<input type="text" name="city" required placeholder="e.g. October">
 </div>
 <div class="inputBox"> 
    <span>State :</span>
...
Egypt">
 ...
 <div class="inputBox">
<span>Pin Code :</span>
<input type="number" min="0" name="pin_code" required placeholder="e.g. 387130">
 </div>
</div>
